  ...
  return (
    <Modal
      ...
      <div
        ...
        <ModalHeader onClickClose={onClickClose} label="Create bookmark" />
        ...
        <div className="w-full flex flex-row items-center justify-end gap-12 pb-24 px-24">
          <DefaultButton
            ...
            <Typography text="caption">Cancel</Typography>
          </DefaultButton>
          <DefaultButton
            ...
            <Typography text="caption">Create bookmark</Typography>
          </DefaultButton>
        </div>
      </div>
    </Modal>
